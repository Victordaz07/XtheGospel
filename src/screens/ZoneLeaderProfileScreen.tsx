// src/screens/ZoneLeaderProfileScreen.tsx
...
export const ZoneLeaderProfileScreen: React.FC = () => {
      ...
      >
        <View style={styles.header}>
          <View style={styles.avatar}>
            <MaterialCommunityIcons name="account-tie" size={60} color="#F59E0B" />
          </View>
          <Text style={styles.username}>{user.displayName || 'Líder de Zona'}</Text>
          <Text style={styles.role}>Líder de Zona</Text>
          {user.zoneName && (
            <Text style={styles.zoneName}>{user.zoneName}</Text>
          )}
        </View>

        <View style={styles.statsContainer}>
          <View style={styles.statCard}>
            <MaterialCommunityIcons name="account-group" size={30} color="#F59E0B" />
            <Text style={styles.statNumber}>Zona</Text>
            <Text style={styles.statLabel}>{user.zoneId || 'Mi zona'}</Text>
          </View>
