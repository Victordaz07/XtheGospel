// src/screens/ZoneLeaderDashboardScreen.tsx
...
import { useZoneLeaderDashboard } from '../hooks/useZoneLeaderDashboard';

export const ZoneLeaderDashboardScreen: React.FC = () => {
  ...
  const { data, loading } = useZoneLeaderDashboard({
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Zona – {user.zoneName || 'Mi zona'}</Text>
      ...
      <View style={styles.quickRow}>
        <TouchableOpacity
          ...
          onPress={() => goTo('ZoneCouncil')}
        >
          <Text style={styles.quickTitle}>Reunión de zona</Text>
          <Text style={styles.quickHint}>Planear o editar</Text>
        </TouchableOpacity>

        <TouchableOpacity
          style={styles.quickButton}
          onPress={() => goTo('ZoneExchanges')}
        >
      ...
      <View style={styles.quickRow}>
        <TouchableOpacity
          style={styles.quickButton}
          onPress={() => goTo('ZoneBaptismalInterviews')}
        >
        ...
        <TouchableOpacity
          style={styles.quickButton}
          onPress={() => goTo('ZoneLeaderMessages')}
        >
          <Text style={styles.quickTitle}>Mensajes</Text>
          <Text style={styles.quickHint}>Enviar a la zona</Text>
        </TouchableOpacity>
      </View>
      ...
      {loading ? (
        <View style={styles.center}>
          <ActivityIndicator />
          <Text>Cargando eventos de la zona…</Text>
        </View>
      ) : (
        <>
