// src/screens/ZoneLeaderNotesScreen.tsx
...
export const ZoneLeaderNotesScreen: React.FC = () => {
  ...
  useEffect(() => {
    ...
    return unsub;
  }, [user.missionId, user.zoneId, user.id]);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Notas personales de la zona</Text>
      ...
      <View style={styles.editorCard}>
        ...
        <TextInput
          ...
          placeholder="Impresiones espirituales, ideas para la zona, notas sobre líderes, etc."
          multiline
          value={form.body}
        ...
        >
          <Text style={styles.shareText}>
            Compartir como mensaje a la zona
          </Text>
        </TouchableOpacity>
      </View>
