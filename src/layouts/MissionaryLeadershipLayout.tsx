      ...
      <div className="layout-shell" style={{ '--leadership-color': roleConfig.color } as React.CSSProperties}>
        ...
        <main className="layout-content">
          <Routes>
            ...
            <Route path="/missionary/leadership/districtLeader/profile" element={<MissionaryProfileScreen />} />
            ...
            <Route path="/missionary/leadership/zoneLeader/profile" element={<MissionaryProfileScreen />} />
            {/* Legacy routes */}
            ...
            <Route path="/missionary/leadership/assistantToPresident/profile" element={<MissionaryProfileScreen />} />
            {/* Legacy routes */}
