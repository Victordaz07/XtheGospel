    ...
    try {
      ...
      if (jsonValue != null) {
        ...
        const uniqueReflections = reflections.filter(
          (reflection: Reflection, index: number, self: Reflection[]) =>
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Éxito',
        editingReflection
          ? 'Reflexión actualizada correctamente.'
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              ...
              const updatedReflections = savedReflections.filter(
                r => r.id !== id,
              );
              const jsonValue = JSON.stringify(updatedReflections);
              await AsyncStorage.setItem('@reflections', jsonValue);
          ...
          >
            <View style={styles.header}>
              ...
              <Text style={styles.headerSubtitle}>
                Comparte tus pensamientos y aprendizajes
              </Text>
            </View>
            ...
            <View style={styles.formContainer}>
              ...
              <View style={styles.shareContainer}>
                <TouchableOpacity
                  ...
                  onPress={() =>
                    setShareWithMissionaries(!shareWithMissionaries)
                  }
                >
                  <View
                    style={[
                  ...
                  <View style={styles.checkboxTextContainer}>
                    <Text style={styles.checkboxTitle}>
                      Compartir con los misioneros
                    </Text>
                    <Text style={styles.checkboxDescription}>
                      Permite que los misioneros vean tu reflexión para poder
                      ayudarte mejor.
                    </Text>
                  </View>
                </TouchableOpacity>
            ...
            {savedReflections.length === 0 && (
              <View style={styles.emptyContainer}>
                <Text style={styles.emptyText}>
                  No tienes reflexiones guardadas aún
                </Text>
